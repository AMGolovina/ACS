...
1. Открываем четыре терминала(можно больше смотря сколько писателей и читателей хотим запустить) и во всех терминалах собираем файлы:
```
gcc init.c    -o init    -pthread
gcc reader.c  -o reader  -pthread
gcc writer.c  -o writer  -pthread
...
### 3. Результаты работы нескольких наблюдателей
